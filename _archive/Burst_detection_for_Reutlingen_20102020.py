# -*- coding: utf-8 -*-
"""
Created on Tue Oct 20 18:23:18 2020
...
inputdirectory = "C:/Users/User/Documents/Jenny/191021_output"
outputdirectory = "C:/Users/User/Documents/Jenny/191021_output_2"
...
filelist= glob.glob("*.h5_crossings_dict.npy")
scale_factor_for_second=1e-06


for file in filelist:
    filename = file
    spikedic = np.load(filename,allow_pickle='TRUE').item() 
    ...
    fig = df[['ISI_per_10ms_bins', 'CMA']].plot(color=colors, linewidth=3, figsize=(16,6), title="Histogram of ISI-bins 10ms whole network - "+str(filename))
    ...
    #burststartdic_ms = burststartdic_to_milliseconds(burststartdic, tick)
    
    os.chdir(outputdirectory)
    np.save(filename+'burststardic.npy', burststartdic)
    
    new_out =outputdirectory+"/"+filename
    os.makedirs(new_out)
    os.chdir(new_out)
