...
def plot_signal_and_spikes_from_bandpassfilteredsignal(bandpassfilteredsignal, 
    ...
    spikes_in_range = spikes[(spikes >= range_in_ticks[0]) & (spikes <= range_in_ticks[1])]
    ...
    # if the time does not start at 0, signal in range will be sliced by the time that is missing
